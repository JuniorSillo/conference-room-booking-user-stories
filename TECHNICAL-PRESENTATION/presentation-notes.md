...
**Slide 7 (50 sec)**  
Docs are first-class: README for quick start, OpenAPI YAML and Swagger for API, curl examples, Postman collection with tests. Repo is organized code in src, everything else in docs.
